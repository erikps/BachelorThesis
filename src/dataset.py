...
def create_datasets (categoriser=HCategoriser(), graph_dir: str="./data/graphs/", output_dir: str="./data/attackinference/"):
    ...
    for path in source_path.glob("*.apx"):
        ...
        framework = WeightedArgumentationFramework.from_file(str(path)) \
                                                  .randomise_weights()
...
if __name__ == "__main__":
    create_datasets()
    # dataset = AttackInferenceDataset(preload=True)
